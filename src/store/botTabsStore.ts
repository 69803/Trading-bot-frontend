...
export const BOT_SYMBOLS: Record<string, string[]> = {
  ...
  cryptobot:   ["GBPUSD", "EURUSD", "AUDUSD", "USDJPY", "NZDUSD"],
...
export const BOT_PROFILES: Record<string, BotProfile> = {
  ...
  cryptobot: {
    id: "cryptobot", name: "Momentum", color: "#a855f7",
    strategyType: "Momentum",
    market: "Forex",
    description: "Lo que sube, sigue subiendo. Identifica divisas con momentum fuerte y sostenido, entra en continuaciones y deja correr la posición.",
    condition: "ADX > 25 · Score ≥ 6/8 · EMA50 + EMA200 alineadas",
    timeframes: [
      { tf: "1H",  role: "Señal + entrada",  primary: true },
      { tf: "4H",  role: "Confirmación macro", primary: true },
    ],
    symbolsList: [
      { symbol: "GBP/USD", stars: 5 }, { symbol: "EUR/USD", stars: 5 },
      { symbol: "AUD/USD", stars: 4 }, { symbol: "USD/JPY", stars: 4 },
      { symbol: "NZD/USD", stars: 3 },
    ],
    indicators: [
      { name: "ROC (14)",      desc: "Aceleración del precio" },
      { name: "RSI (10)",      desc: "50–75 zona momentum alcista" },
      { name: "EMA 50 / 200",  desc: "Alineación macro" },
      { name: "ADX + DI± (14)", desc: "> 25 + DI direccional" },
      { name: "MACD 12/26/9",  desc: "Confirmación momentum" },
    ],
    risk: {
      sl: "ATR × 1.5",  tp: "ATR × 4.0 (trailing en práctica)",
      riskPerTrade: "1–1.5%",  maxPositions: 2,
      dailyDD: "2%",  cooldown: "2h",
    },
    entryLong:  ["Score ≥ 6/8", "Precio > EMA200", "ADX > 25, DI+ > DI−", "MACD > 0 y subiendo", "RSI(10) 50–75", "ROC > 0"],
    entryShort: ["Score ≥ 6/8", "Precio < EMA200", "ADX > 25, DI− > DI+", "MACD < 0 y bajando",  "RSI(10) 25–50", "ROC < 0"],
    emergencyExit: ["ADX < 20 por 2 velas → cerrar 50%", "Divergencia MACD + ROC → cerrar todo", "Precio rompe EMA200 en contra"],
  },
