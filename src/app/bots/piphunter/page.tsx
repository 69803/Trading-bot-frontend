...
export default function PipHunterPage() {
  ...
  const handleIniciar = async () => {
    ...
    setError(null);
    try {
      await api.post("/bot/activate/piphunter");
      addTab("piphunter");
  ...
  return (
    <div style={{
      ...
      position: "relative",
      overflow: "hidden",
      backgroundImage: "url('/bot-piphunter.jpeg')",
      ...
      <div style={{
        ...
        background: "linear-gradient(90deg, rgba(20,8,2,0.82) 0%, rgba(20,8,2,0.45) 40%, transparent 70%)",
        zIndex: 1,
      }} />
      ...
      <div style={{
        ...
        boxShadow: "0 0 36px rgba(251,146,60,0.15), 0 16px 48px rgba(0,0,0,0.6)",
      }}>

        {/* back */}
        <button onClick={() => router.back()} style={{
          background: "transparent", border: "none",
          color: "rgba(253,186,116,0.6)", fontSize: 13,
        ...
        <div style={{
          ...
          <span style={{ color: "#fdba74", fontSize: 12, fontWeight: 600, letterSpacing: 0.5 }}>BREAKOUT · FOREX</span>
        </div>
        ...
        <p style={{
          ...
          Detecta rupturas de niveles clave y entra cuando el precio explota. Gestión de riesgo estricta con TP escalonado.
        </p>
